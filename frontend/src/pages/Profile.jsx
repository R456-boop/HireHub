        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          ...
          <div className="grid gap-6 lg:grid-cols-[340px_1fr]">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/[0.08] bg-[#0c0810] p-6 shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
              ...
              <button
                type="button"
                className="relative z-10 mt-8 flex w-full items-center justify-center gap-2 rounded-xl border border-purple-500/20 bg-purple-500/10 px-4 py-3 text-sm font-medium text-[#c084fc] transition hover:border-purple-400/40 hover:bg-purple-500/20"
              >
